...
<form  method="post" action="?page=proses-add-krp">
...
<!-- end wajib universitas -->
  ...
  <div class="kotak-penalaran" style="margin-bottom: 30px;">
    ...
    <!-- end sosial -->
        ...
        <!-- button -->
 <div class="mt-4 mb-4">
            <button name="KRPLanjut" type="submit" class="btn btn-primary btn-lg" style="background-color:#042366;">
                <i class="bi bi-arrow-right-circle-fill"></i> Lanjutkan
            </button>
        </div>
</form>
</div>
